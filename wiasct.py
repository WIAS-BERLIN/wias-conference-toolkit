...
config_sty_content = ["%this file is generated by config/__init__.py and should not be edited by hand%"]
for name, color_object in color_dict.items():
    config_sty_content.append(color_object.tex_definition())

with open('../config/tex-templates/wiasct_config.sty', 'w') as f:
